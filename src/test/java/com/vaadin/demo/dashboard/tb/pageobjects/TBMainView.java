...
public class TBMainView extends TestBenchTestCase {
    ...
    public TBStatisticsView openStatisticsView() {
        getDashboardMenu().$(ButtonElement.class).caption("Transactions")
                .first().click();
        return new TBStatisticsView(driver);
    }

    public TBDetailedView openDetailedView() {
        getDashboardMenu().$(ButtonElement.class).caption("Transactions")
                .first().click();
        return new TBDetailedView(driver);
    }
    
    public TBServiceView openServiceView() {
        getDashboardMenu().$(ButtonElement.class).caption("Service")
                .first().click();
        return new TBServiceView(driver);
    }
    
    public TBLocationView openLocationView() {
        getDashboardMenu().$(ButtonElement.class).caption("DetailedRequests")
                .first().click();
        return new TBLocationView(driver);
    }
